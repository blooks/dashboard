...
Meteor.methods({
  getKrakenData: function (exchange) {
    var
      key = exchange.credentials.APIKey,
      secret = exchange.credentials.secret,
      krakenClient = new Kraken(key, secret),
      syncKrakenClient = Async.wrap(krakenClient, ['api']),
      apiDataPackage = syncKrakenClient.api('Ledgers', {}),
      //turn JSON Object to array
      numberOfKrakenTrades = apiDataPackage.result.count,
      krakenData = [],
      ledgerIdOfLastEntry = "",
      securityLoopCounter = 0;
